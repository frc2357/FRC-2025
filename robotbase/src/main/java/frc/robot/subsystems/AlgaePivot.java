...
public class AlgaePivot extends SubsystemBase {
    ...
    public AlgaePivot() {
        m_leftMotor = new SparkMax(CAN_ID.LEFT_ALGAE_PIVOT_MOTOR, MotorType.kBrushless);
        m_rightMotor = new SparkMax(CAN_ID.RIGHT_ALGAE_PIVOT_MOTOR, MotorType.kBrushless);
