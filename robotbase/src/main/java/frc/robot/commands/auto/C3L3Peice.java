...
public class C3L3Peice extends AutoBase {
  ...
  public C3L3Peice() {
    super("Cage Left 3 | 3 P", "CB3ToBranchI");
    ...
    // AutoTrajectory BlueSToBranchJ = m_routine.trajectory("BlueSToBranchJ");
    ...
    branchLToBlueS
      ...
      .onTrue(
        new CoralIntake()
          .andThen(new CoralRetract())/* .withDeadline(BlueSToBranchI.cmd())*/
      );
