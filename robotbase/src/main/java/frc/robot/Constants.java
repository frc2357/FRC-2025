...
public final class Constants {
    ...
    public static final class SWERVE {
        ...
        public static final LinearVelocity ROBOT_NO_TIP_SPEED = Units.MetersPerSecond.of(.5);
    }
    ...
    public static final class ELEVATOR {
        ...
        public static final ClosedLoopConfig CLOSED_LOOP_CONFIG_LEFT = MOTOR_CONFIG_LEFT.closedLoop
                ...
                .outputRange(-1, 1);
        public static final Angle SMART_MOTION_ALLOWED_ERROR_ROTATIONS = Units.Rotations.of(0.1);

        @SuppressWarnings("removal")
        public static final SmartMotionConfig SMART_MOTION_CONFIG_LEFT = CLOSED_LOOP_CONFIG_LEFT.smartMotion
    ...
    public static final class LATERATOR {
        ...
        public static final ClosedLoopConfig CLOSED_LOOP_CONFIG_LEFT = MOTOR_CONFIG.closedLoop
                .pidf(MOTOR_P, MOTOR_I, MOTOR_D, MOTOR_F)
                .velocityFF(MOTOR_VEL_FF)
                .outputRange(-1, 1);

        public static final Angle SMART_MOTION_ALLOWED_ERROR_ROTATIONS = Units.Rotations.of(0.05);

        public static final double AXIS_MAX_SPEED = 0.5;

        @SuppressWarnings("removal")
        public static final SmartMotionConfig MAX_MOTION_CONFIG_LEFT = CLOSED_LOOP_CONFIG_LEFT.smartMotion
                .allowedClosedLoopError(
                        SMART_MOTION_ALLOWED_ERROR_ROTATIONS.in(Units.Rotations))
                .maxAcceleration(10000)
                .maxVelocity(3500);
        ...
        public static final Distance OUTPUT_PULLEY_PITCH_DIAMETER = Units.Millimeters.of(46.188);
        public static final Distance OUTPUT_PULLEY_CIRCUMFERENCE = OUTPUT_PULLEY_PITCH_DIAMETER.times(Math.PI);
    ...
    public static class CLIMBER_WINCH {
        ...
        public static final SparkBaseConfig MOTOR_CONFIG_LEFT = new SparkMaxConfig()
                ...
                .inverted(false);
        public static final SparkBaseConfig MOTOR_CONFIG_RIGHT = new SparkMaxConfig().apply(MOTOR_CONFIG_LEFT)
                .inverted(true);
    ...
    public static final class PHOTON_VISION {
        ...
        public static final Optional<ConstrainedSolvepnpParams> POSE_EST_PARAMS = Optional.of(
        ...
        public static final List<VisionTargetSim> SIM_TARGETS = FIELD_CONSTANTS.APRIL_TAG_LAYOUT.getTags().stream()
                .map((AprilTag tag) -> {
    ...
    public static final class FIELD_CONSTANTS {
        ...
        public static final AprilTagFields APRIL_TAG_FIELD = AprilTagFields.k2025ReefscapeAndyMark;

        public static final AprilTagFieldLayout HOME_FIELD_LAYOUT = Utility.makeHomeField();
    ...
    public static class DRIVE_TO_POSE {
        ...
        public static final Constraints DRIVE_DEFAULT_CONSTRAINTS = new TrapezoidProfile.Constraints(30, 9);
        public static final Constraints DRIVE_FINAL_APPROACH_CONSTRAINTS = new TrapezoidProfile.Constraints(10, 5);

        public static final Constraints THETA_DEFAULT_CONSTRAINTS = new TrapezoidProfile.Constraints(15, 9);

        public static final ProfiledPIDController DRIVE_CONTROLLER = new ProfiledPIDController(8, 0.0, 0.0,
                DRIVE_DEFAULT_CONSTRAINTS);

        public static final ProfiledPIDController THETA_CONTROLLER = new ProfiledPIDController(6, 0.0, 0.0,
                THETA_DEFAULT_CONSTRAINTS);
        ...
        public static final Distance IDEAL_DISTANCE_FROM_REEF = COLLISION_DETECTION.REEF_BOUNDARY
                .plus(Units.Feet.of(4));
    }
    ...
    public static final class COLLISION_DETECTION {
        ...
        public static final SATVector[] REEF_SAT_POLY = CollisionDetection.createReefPolygon();
    }
    ...
    public static class ROBOT_CONFIGURATION {
        ...
        public static final Transform2d FRONT_LEFT_CORNER_TRANSFORM = new Transform2d(
                FRAME_WIDTH.div(2),
                FRAME_LENGTH.div(2),
                Rotation2d.kZero);
        public static final Transform2d FRONT_RIGHT_CORNER_TRANSFORM = new Transform2d(
                FRAME_WIDTH.div(2),
                FRAME_LENGTH.div(2).unaryMinus(),
                Rotation2d.kZero);
        public static final Transform2d BACK_LEFT_CORNER_TRANSFORM = new Transform2d(
                FRAME_WIDTH.div(2).unaryMinus(),
                FRAME_LENGTH.div(2),
                Rotation2d.kZero);
        public static final Transform2d BACK_RIGHT_CORNER_TRANSFORM = new Transform2d(
                FRAME_WIDTH.div(2).unaryMinus(),
                FRAME_LENGTH.div(2).unaryMinus(),
                Rotation2d.kZero);
         ...
         */
        public static final double MOMENT_OF_INERTIA_SIMPLIFIED_DISTRIBUTION = (1.0 / 12) *
