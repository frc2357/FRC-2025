...
public final class Constants {
  ...
  public static final class SWERVE {
    ...
    public static final AngularVelocity MAX_ANGULAR_VELOCITY = Units.RadiansPerSecond.of(Math.PI * 2);

    public static final double STATIC_FEEDFORWARD_METERS_PER_SECOND = 0.093545;

    public static final LinearAcceleration MAXIMUM_LINEAR_ACCELERATION = Units.MetersPerSecondPerSecond.of(4.5); // TODO:
                                                                                                                 // tune
                                                                                                                 // this
    public static final AngularAcceleration MAXIMUM_ANGULAR_ACCELERATION = Units.DegreesPerSecondPerSecond.of(120); // TODO:
                                                                                                                    // tune
                                                                                                                    // this
  ...
  public static final class ELEVATOR {
    ...
    public static final Distance OUTPUT_PULLEY_CIRCUMFERENCE = HTD5_PULLEY_PITCH.times(OUTPUT_PULLEY_NUMBER_OF_TEETH);
  ...
  public static final class LATERATOR {
    ...
    public static final Distance OUTPUT_PULLEY_DIAMETER = Units.Millimeters.of(
        46.188);
    public static final Distance OUTPUT_PULLEY_CIRCUMFERENCE = OUTPUT_PULLEY_DIAMETER.times(Math.PI);
  ...
  public static final class ALGAE_PIVOT {
    ...
    public static final ClosedLoopConfig CLOSED_LOOP_CONFIG_LEFT = LEFT_MOTOR_CONFIG.closedLoop
  ...
  public static final class PHOTON_VISION {
    ...
    public static final PoseStrategy FALLBACK_STRATEGY = PoseStrategy.CLOSEST_TO_REFERENCE_POSE;
    ...
    public static final LinearVelocity MAX_ACCEPTABLE_VELOCITY = Units.MetersPerSecond.of(3.5);
  ...
  public static class DRIVE_TO_POSE {
    ...
    public static final ProfiledPIDController AUTO_ALIGN_DRIVE_CONTROLLER = new ProfiledPIDController(
        8,
        0.0,
        0.0,
        new TrapezoidProfile.Constraints(1.5, 1));

    public static final ProfiledPIDController AUTO_ALIGN_THETA_CONTROLLER = new ProfiledPIDController(
        6,
        0.0,
        0.0,
    ...
    public static final Rotation2d ROTATE_AROUND_REEF_ROTATIONS = new Rotation2d(Units.Rotations.of(0.05));
     ...
     */
    public static final Distance IDEAL_DISTANCE_FROM_REEF = COLLISION_DETECTION.REEF_BOUNDARY.plus(Units.Feet.of(1.5));
  ...
  public static class FIELD { // pulled directly from Choreo or field drawings provided by FIRST
    ...
    public static class CORAL_STATION {
      ...
      public static final Transform2d UPPER_STATION_SLOT_TO_SLOT_TRANSFORM = new Transform2d(
          Units.Inches.of(5.65685),
          Units.Inches.of(5.65685),
          Rotation2d.kZero);

      public static final Pose2d UPPER_STATION_DESIRED_SLOT = UPPER_STATION_LEFTMOST_USABLE_SLOT.transformBy(
      ...
      public static final Pose2d LOWER_STATION_LEFTMOST_USABLE_SLOT = // TODO: tune this to field
          new Pose2d(
              ...
              1.3386709690093994,
              new Rotation2d(-2.206778871255995));
      public static final Transform2d LOWER_STATION_SLOT_TO_SLOT_TRANSFORM = new Transform2d(
          Units.Inches.of(5.65685),
          Units.Inches.of(-5.65685),
          Rotation2d.kZero);

      public static final Pose2d LOWER_STATION_DESIRED_SLOT = LOWER_STATION_LEFTMOST_USABLE_SLOT.transformBy(
  ...
  public static class CLIMBER {
    ...
    public static final SparkBaseConfig MOTOR_CONFIG_THREE = new SparkMaxConfig()
        .idleMode(IDLE_MODE)
        .smartCurrentLimit((int) STALL_LIMIT.in(Units.Amps))
        .openLoopRampRate(1)
        .follow(CAN_ID.CLIMBER_MOTOR_ONE);
