...
public final class Constants {
  ...
  public static class CAN_ID {
    ...
    public static final int ALGAE_RUNNER_MOTOR = -1;
    public static final int LEFT_ALGAE_PIVOT_MOTOR = -1;
    public static final int RIGHT_ALGAE_PIVOT_MOTOR = -1;
  }
  ...
  public static final class ALGAE_RUNNER {
    ...
    public static final SparkBaseConfig MOTOR_CONFIG = new SparkMaxConfig()
        ...
        .smartCurrentLimit((int)MOTOR_STALL_LIMIT.in(Units.Amps), (int)MOTOR_FREE_LIMIT.in(Units.Amps));
  }
